...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ActorRoute; });
...
function loadActor(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('./Actors/GetActor/${id}', { method: 'get', credentials: 'include' })];
                case 1:
                    result = _a.sent();
...
var ActorRoute = /** @class */ (function (_super) {
    __extends(ActorRoute, _super);
    function ActorRoute(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { actor: "loading" };
        return _this;
    }
    ActorRoute.prototype.componentWillMount = function () {
        var _this = this;
        loadActor(this.props.match.params.actor).then(function (a) { return _this.setState(__assign({}, _this.state, { actor: a })); });
    };
    ActorRoute.prototype.render = function () {
        if (this.state.actor == "loading")
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "Loading...");
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Actor, { preview: this.props.match.params.preview == 'true', actor: this.state.actor });
    };
    return ActorRoute;
...
var Actor = /** @class */ (function (_super) {
    ...
    Actor.prototype.render = function () {
        if (this.props.preview) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, this.props.actor.name);
        }
        else {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoviesManager", function() { return MoviesManager; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActorsManager", function() { return ActorsManager; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Actor__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Movie__ = __webpack_require__(29);
...
var Home = /** @class */ (function (_super) {
    ...
    function Home(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { hometext: "loading" };
        return _this;
    }
    Home.prototype.render = function () {
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h2", null, "Home"));
    };
    return Home;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]));
...
function loadMovies() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://localhost:5000/api/movie/GetAll', { method: 'get', credentials: 'include' })];
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, result.json()];
                case 2:
...
var MoviesManager = /** @class */ (function (_super) {
    __extends(MoviesManager, _super);
    function MoviesManager(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { movies: "loading" };
        return _this;
    }
    MoviesManager.prototype.componentWillMount = function () {
        var _this = this;
        loadMovies().then(function (ms) { return _this.setState(__assign({}, _this.state, { movies: ms })); });
    };
    MoviesManager.prototype.render = function () {
        if (this.state.movies == "loading")
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "Loading..");
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "movies" }, this.state.movies.map(function (m) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "movies-movie" },
                m.title,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["b" /* Link */], { to: "/movies/" + m.id },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", null, "Expand actor")));
        }));
    };
...
function loadActors() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://localhost:5000/api/actor/GetAll', { method: 'get', credentials: 'include' })];
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, result.json()];
                case 2:
...
var ActorsManager = /** @class */ (function (_super) {
    __extends(ActorsManager, _super);
    function ActorsManager(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { actors: "loading" };
        return _this;
    }
    ActorsManager.prototype.componentWillMount = function () {
        var _this = this;
        loadActors().then(function (as) { return _this.setState(__assign({}, _this.state, { actors: as })); });
    };
    ActorsManager.prototype.render = function () {
        if (this.state.actors == "loading")
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "Loading..");
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "actors" }, this.state.actors.map(function (a) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "actors-actor" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__components_Actor__["a" /* Actor */], { actor: a, preview: true }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["b" /* Link */], { to: "/actors/false/" + a.id },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", null, "Expand actor")));
        }));
    };
...
var Routing = /** @class */ (function (_super) {
    ...
    Routing.prototype.render = function () {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["a" /* BrowserRouter */], null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", null,
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["b" /* Link */], { to: "/home" }, "Home")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["b" /* Link */], { to: "/movies" }, "Movies")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["b" /* Link */], { to: "/actors" }, "Actors"))),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("hr", null),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */], { exact: true, path: "/home", component: Home }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */], { exact: true, path: "/movies", component: MoviesManager }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */], { exact: true, path: "/actors", component: ActorsManager }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */], { exact: true, path: "/actors/:preview/:actor", component: __WEBPACK_IMPORTED_MODULE_2__components_Actor__["b" /* ActorRoute */] }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */], { exact: true, path: "/movies/:preview/:movie", component: __WEBPACK_IMPORTED_MODULE_3__components_Movie__["a" /* MovieRoute */] }))));
    };
    return Routing;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]));
/* harmony default export */ __webpack_exports__["default"] = (Routing);
__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"](__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Routing, null), document.getElementById("root"));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MovieRoute; });
/* unused harmony export Movie */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_router_dom__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Actor__ = __webpack_require__(8);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
function loadMovie(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('./Movies/GetMovie/${id}', { method: 'get', credentials: 'include' })];
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, result.json()];
                case 2:
...
var MovieRoute = /** @class */ (function (_super) {
    __extends(MovieRoute, _super);
    function MovieRoute(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { movie: "loading" };
        return _this;
    }
    MovieRoute.prototype.componentWillMount = function () {
        var _this = this;
        loadMovie(this.props.match.params.movie).then(function (m) { return _this.setState(__assign({}, _this.state, { movie: m })); });
    };
    MovieRoute.prototype.render = function () {
        if (this.state.movie == "loading")
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "Loading...");
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Movie, { preview: this.props.match.params.preview == 'true', movie: this.state.movie });
    };
    return MovieRoute;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]));
...
var Movie = /** @class */ (function (_super) {
    ...
    Movie.prototype.render = function () {
        if (this.props.preview) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, this.props.movie.title);
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
                    ...
                    " "),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "movie-actors" }, this.props.movie.actors.map(function (a) { return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "movie-actors-actor" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__Actor__["a" /* Actor */], { actor: a, preview: true }),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */], { to: "/actor/false" + a.id },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", null, "Expand actor"))); })));
        }
    };
    return Movie;
